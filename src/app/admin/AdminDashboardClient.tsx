  ...
  return (
    <div className="min-h-screen bg-background max-w-7xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
          ...
          <div className="mb-12 flex items-center justify-between bg-linear-to-br
          from-primary/10 via-primary/5 to-background rounded-3xl p-8 border border-primary/20
          ">

            {/* Left side */}
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 bg-background/10 rounded-full px-3 py-1 border border-primary/20">
                <div className="w-2 h-2 rounded-full bg-primary animate-pulse"></div>
                <span className="text-sm text-primary font-medium">Admin Dashboard</span>
              </div>
              <div>
