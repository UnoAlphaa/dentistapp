  ...
  return (
    <section className='relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto'>
      <div className='text-center mb-20'>
        <div className='inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-primary/5 to-primary/10 
        rounded-full border border-primary/10 backdrop-blur-sm mb-6'>
          <ZapIcon className='size-4 text-primary'/>
          <span className='text-primary text-sm font-medium'>Simple Process</span>
        </div>

        <h2 className='text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight '>
          <span className='bg-linear-to-br bg-clip-text text-transparent from-foreground to-foreground/70'>Three steps to</span>
          <br />
          <span className='bg-linear-to-br from-primary to-primary/70 bg-clip-text text-transparent'>better dental health</span>
        </h2>

        <p className='text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed'>Our streamlined process makes dental
          care accessible, convenient, and stress-free for everyone.
        </p>
      </div>
      {/* Steps */}
      <div className='relative'>
        {/* A connection line */}
        <div className='absolute top-1/2 left-0 right-0 h-1 bg-linear-to-r from-transparent via-primary/30 to-transparent transform -translate-y-1/2 hidden lg:block'></div>
        {/* steps */}
        <div className='grid lg:grid-cols-3 gap-12 lg:gap-8'>
          {/* step 1 */}
          <div className='relative group'>
            <div className='className="relative bg-linear-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10'>
          ...
          <div className='relative group'>
            <div className='className="relative bg-linear-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10'>
                ...
                {/* Icon */}
              <div className="w-20 h-20 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300 mb-6">
                <Image src="/brain.png" alt="Voice Chat" width={40} height={40} className="w-14" />
              </div>
          ...
          <div className='relative group'>
            <div className='className="relative bg-linear-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10'>
                ...
                {/* Icon */}
              <div className="w-20 h-20 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300 mb-6">
                <Image src="/calendar.png" alt="Voice Chat" width={40} height={40} className="w-14" />
              </div>
