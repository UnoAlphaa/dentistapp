...
function Hero() {
  return (
    <section className="relative h-screen flex items-center overflow-hidden pt-30">
      {/* GRID BG  */}
      ...
      {/* GRADIENT ORBS */}
      <div className="absolute top-20 left-1/4 w-72 h-72 bg-linear-to-br from-primary/20 to-primary/10 rounded-full blur-3xl" />
      <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-linear-to-br from-primary/15 to-primary/5 rounded-full blur-3xl" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                {/* BADGE */}
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-br from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm">
